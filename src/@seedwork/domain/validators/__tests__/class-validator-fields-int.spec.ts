...
//configurar decorators no .swcrc: 
...
describe('ClassValidatorFields integration test', () => {
    ...
    it('should validate success', () => {
        ...
        expect(validator.validate({name: 'N1', price: 5})).toBeTruthy()
        expect(validator.validatedData).toStrictEqual(new StubRules({name: 'N1', price: 5}))
    })
})